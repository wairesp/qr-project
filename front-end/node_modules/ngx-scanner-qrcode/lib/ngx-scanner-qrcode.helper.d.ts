 ...
 * @returns
 */
export declare const FILES_TO_SCAN: (files: File[] | undefined, configs: ScannerQRCodeConfig, quality?: number, type?: string, as?: AsyncSubject<ScannerQRCodeSelectedFiles[]>) => AsyncSubject<ScannerQRCodeSelectedFiles[]>;
/**
 ...
 * @returns
 */
export declare const COMPRESS_IMAGE_FILE: (files?: File[], quality?: number, type?: string) => Promise<File[] | FileList>;
/**
 * REMOVE_RESULT_PANEL
 * @param element
 */
